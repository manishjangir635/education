...
class BVSelect {
    ...
    }) 
    {
                ...
                item.addEventListener('click', (e) => {
                    ...
                    if (item.classList.contains("bv_disabled") || item.classList.contains("nofocus") || item.classList.contains("bv_separator")) {} else {
                        if (selected_option.attributes.multiple) {
                            ...
                            document.getElementById("main_" + randomID).innerHTML = SelectedNames + "<i id='arrow_" + randomID + "' class='arrows_bv arrow bi bi-chevron-down'></i>";
                            ...
                            // Updates main div
                            document.getElementById("main_" + randomID).innerHTML = item.textContent + "<i id='arrow_" + randomID + "' class='arrows_bv arrow bi bi-chevron-down'></i>";
        ...
        this.CriarDivBase = function() {
            ...
            document.getElementById("bv_" + randomID).insertAdjacentHTML('afterbegin', '<div id="main_' + randomID + '" style="width:' + this.width + ';" class="bv_atual bv_background form-control"></div><ul id="ul_' + randomID + '" class="bv_ul_inner bv_background"></ul>');
            ...
            document.getElementById("main_" + randomID).innerHTML = first_option_text + "<i id='arrow_" + randomID + "' class='arrows_bv arrow bi bi-chevron-down'></i>";
