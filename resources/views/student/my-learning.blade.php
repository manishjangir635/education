                ...
                <div class="tab-pane fade show active" id="nav-pik1" role="tabpanel" aria-labelledby="nav-pik1-tab"
                    ...
                    <div class="row gy-4">
                            ...
                            <div class="course-block">
                                ...
                                <div class="course-detail">
                                    ...
                                    <div class="mt-20 d-flex align-items-center">
                                        <a class="me-3 theme-btn" href="{{route('course_play.index')}}">Start Course</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="course-block">
                                <div class="ratio ratio-16x9 course-thumb">
                                    <iframe src="https://www.youtube.com/embed/DZbbSwRukYw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                                <div class="course-detail">
                                    <h4 class="font-16 text-darkblue font-bold">Unlocking Your Potential: 5
                                        Exercises to Build Creative Confidence</h4>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="course-block">
                                <div class="ratio ratio-16x9 course-thumb">
                                    <iframe src="https://www.youtube.com/embed/PcLRmUTitvQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                                <div class="course-detail">
                                    <h4 class="font-16 text-darkblue font-bold">Unlocking Your Potential: 5
                                        Exercises to Build Creative Confidence</h4>
