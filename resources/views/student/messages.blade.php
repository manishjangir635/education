    ...
    <section class="content-block pt-60 pb-60">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <div class="ui-block">
                        <div class="d-flex align-items-center justify-content-between p-4 border-bottom1">
                            <h1 class="playfair font-24 font-bold text-darkblue mb-0">Messages</h1>
                            <a class="theme-btn2">Compose</a>
                        </div>
                        <div class="p-4">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6  mt-4">
                                    <div class="border1 message-block">
                                        <div class="message-header">
                                            <div class="message-header-img"><img src="{{url('/')}}/public/student/images/userImg.jpg" alt="image"><span class="active-user"></span></div>
                                        ...
                                        <div class="message-page">
                                            <div class="message-index">
                                                ...
                                                <div class="outgoing-chat">
                                                    ...
                                                    <div class="outgoing-chat-img"><img src="{{url('/')}}/public/student/images/userImg.jpg" alt=""><span class="time">12:45 pm</span></div>
                                                </div>
                                                <div class="recived-chat">
                                                    <div class="recived-chat-img"><img src="{{url('/')}}/public/student/images/profile-img.png" alt=""><span class="time">12:45 pm</span></div>
                                            ...
                                            <div class="msg-bottom">
                                                <div class="input-group align-items-center">
                                                    ...
                                                    <div class="input-group-append mx-2"> <button class="btn" type="btn">
                                                        <img src="{{url('/')}}/public/student/images/send.svg" alt="send"></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
