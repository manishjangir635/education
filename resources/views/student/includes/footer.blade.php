...
<footer class="bg-darkblue pt-40">
        <div class="container">
            <div class="row">
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <p>© Part-Time BHMS Academy , Inc. 2022</p>
                    </div>
    ...
    <script src="{{assets('/student/js/jquery-3.6.0.min.js')}}"></script>
    <script src="{{assets('/student/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{assets('/student/js/swiper-bundle.min.js')}}"></script>
    <script src="{{assets('/student/js/bvselect.js')}}"></script>
