...
<head>
    ...
    <link type="text/css" href="{{asset('public/student/css/bootstrap.min.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('public/student/css/bootstrap-icons.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('public/student/css/swiper-bundle.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/student/css/bvselect.css')}}">
    <link type="text/css" href="{{asset('public/student/css/reset.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('public/student/css/style.css')}}" rel="stylesheet">
    <link type="text/css" href="{{asset('public/student/css/responsive.css')}}" rel="stylesheet">
</head>
...
<header>
        <div class="container-fluid">
            <nav class="navbar navbar-expand-md">
                <a class="logo" href="{{route('index')}}"><img src="{{asset('public/student/images/logo.svg')}}" width="144" height="60" alt="Logo"></a>
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
                    <div class="offcanvas-header">
                        <a href="index.html"><img src="{{asset('public/student/images/logo.svg')}}" width="100" height="42" alt="Logo"></a>
                ...
                <div class="dropdown nav-item">
                    <a href="javaceript:void(0);" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{asset('public/student/images/userImg.jpg')}}" alt="User" width="50" height="50" class="rounded-circle">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end fade-up" aria-labelledby="dropdownUser">
                        <div class="d-flex mt-2 mb-3">
                            <img src="{{asset('public/student/images/userImg.jpg')}}" alt="User" width="50" height="50"
