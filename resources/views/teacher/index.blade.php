                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="input-group">
                            ...
                            <button type="button" class="themeBtn position-absolute end-0 z-index-3 h-100"><img
                                    src="images/search.svg" width="22" height="22" alt="Icon"></button>
                        </div>
                    </div>
                ...
                <div class="card mb-20">
                    <div class="d-md-flex">
                        <div class="thumbBlock p-3">
                            <img src="images/blankImg.svg" class="img-fluid grayscale h-auto" alt="img">
                        </div>
                        <div class="col">
                ...
                <div class="card mb-20">
                    <div class="d-md-flex">
                        <div class="thumbBlock">
                            <img src="images/v-thumb.jpg" class="img-fluid w-100" alt="img">
                        </div>
